          ...
          <div className="grid gap-12 items-start">
            ...
            >
              ...
              <div className="rounded-[2.5rem] overflow-hidden shadow-2xl border border-border/70 bg-black aspect-[16/9] mb-12">
                <img
                  src="https://ellprnxjjzatijdxcogk.supabase.co/storage/v1/object/public/superdev-project-images/5f6c1670-6f8a-4941-aa9d-ae316b4e8606/hqlx1j3gjqyg8uhhqtucg/1772494084912-ChatGPT-Image-Mar-3-2026-07-22-59-AM.png"
                  alt="Vitamin C serum bottle on blue background with serum textures, lemon slices, and capsules"
