...
const barData = [
  ...
  { name: "Successful", count: 102, fill: "#10b981" },
  { name: "Ongoing", count: 10, fill: "#FBA834" },
  { name: "Undetermined", count: 8, fill: "#60C6F0" }
];
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        >
          ...
          <div className="absolute top-12 right-12 text-right">
            ...
            <div className="font-display text-5xl text-accent leading-none">90%</div>
          </div>
        </motion.div>
        ...
        >
          <div className="mb-10 flex justify-between items-start">
            ...
            <div className="bg-emerald-50 text-emerald-700 px-6 py-3 rounded-2xl border border-emerald-100 flex flex-col items-center">
              ...
              <span className="font-display text-4xl">80%</span>
            </div>
          </div>
