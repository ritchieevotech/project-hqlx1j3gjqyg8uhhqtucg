...
export const ContentResults = () => {
  return (
    <section id="results" className="py-16 bg-background overflow-hidden scroll-mt-28">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="font-heading text-2xl md:text-3xl lg:text-4xl text-primary text-center mb-8 tracking-tight">
            Success Rate
          </h3>
        </motion.div>
