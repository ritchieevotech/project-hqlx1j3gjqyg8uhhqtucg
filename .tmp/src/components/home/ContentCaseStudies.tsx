...
const caseStudies = [
  ...
  },
  {
    ...
    image:
      "https://ellprnxjjzatijdxcogk.supabase.co/storage/v1/object/public/superdev-project-images/5f6c1670-6f8a-4941-aa9d-ae316b4e8606/hqlx1j3gjqyg8uhhqtucg/1772493948730-ChatGPT-Image-Mar-3-2026-07-24-37-AM.png",
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <h2 className="font-heading text-3xl md:text-5xl lg:text-6xl text-primary mb-6 tracking-tight">
            Real <span className="squiggly-underline">Case Studies</span>
          </h2>
