...
const benefits = [
  ...
  },
  {
    ...
    description: "Deep expertise in PDP performance, SEO alignment, and Rufus readiness. We handle the content architecture so you don't have to build a specialized Amazon division from scratch.",
    icon: Target,
  },
  {
